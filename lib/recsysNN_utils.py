...
def load_data():
    ...
    item_train = genfromtxt('./data/lab06/content_item_train.csv', delimiter=',')
    user_train = genfromtxt('./data/lab06/content_user_train.csv', delimiter=',')
    y_train    = genfromtxt('./data/lab06/content_y_train.csv', delimiter=',')
    with open('./data/lab06/content_item_train_header.txt', newline='') as f:    #csv reader handles quoted strings better
        item_features = list(csv.reader(f))[0]
    with open('./data/lab06/content_user_train_header.txt', newline='') as f:
        user_features = list(csv.reader(f))[0]
    item_vecs = genfromtxt('./data/lab06/content_item_vecs.csv', delimiter=',')

    movie_dict = defaultdict(dict)
    count = 0
#    with open('./data/lab06/movies.csv', newline='') as csvfile:
    with open('./data/lab06/content_movie_list.csv', newline='') as csvfile:
    ...
    # with open('./data/lab06/content_user_to_genre.pickle', 'rb') as f:
    #     user_to_genre = pickle.load(f)

    # option1 without pickle
    user_to_genre = pd.read_pickle('./data/lab06/content_user_to_genre.pickle')

    # option2 without pickle
    # user_to_genre = joblib.load("my_file.pkl")
